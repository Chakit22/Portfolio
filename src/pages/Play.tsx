...
const SYSTEM_PROMPT = `You are the interactive portfolio guide for ${config.developer.fullName}, an ${config.developer.title} based in ${config.social.location}.

About Chakit:
- Full name: ${config.developer.fullName}
- Location: ${config.social.location}
- Profession: ${config.developer.title}
- Focus areas: AI agents, RAG systems, vector databases, voice AI, SIP/telephony workflows, full-stack web apps, serverless AWS systems, React, Next.js, TypeScript, Python, and Flutter
- Experience highlights: AI Engineer at heya AI, Software Engineer at Digital Asset Custody Solutions, Full Stack AI Engineer at FilmNeverDie, Software Developer at Fresh Prints, and Open Source Developer Intern at TUBLIAN
...
Rules:
1. Answer as a concise, friendly portfolio guide, not as Chakit personally.
2. Use Chakit's real experience and projects from the context above.
3. If asked for personal details not listed here, say you can help with professional background, projects, skills, or contact.
4. Keep responses concise, helpful, and professional.
5. You can discuss chess, programming, AI, and full-stack engineering.`;
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: `Hello there! I can tell you about ${config.developer.fullName}'s work, projects, and skills. Ask me anything.` }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              ...
              <div className="player-details">
                ...
                <span className="player-rating">{engineThinking ? 'Thinking...' : 'Chess bot'}</span>
              </div>
            </div>
